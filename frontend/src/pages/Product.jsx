      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            aliquid consequatur ipsum dolore eos obcaecati sapiente. Cupiditate,
            facilis aliquid.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores
            temporibus nesciunt voluptas tempora voluptate blanditiis repellat
            pariatur? Enim perferendis nobis sit quas beatae magni ullam.
          </p>
        </div>
      </div>
      {/* ---- related products---------- */}
